...
{{--                        <div class="form__field">--}}
{{--                            <input type="email" name="email" value="{{ old('email') }}" placeholder="info@mailaddress.com">--}}
{{--                        </div>--}}
{{--                        @error('email')--}}
{{--                        <div class="form__field">--}}
{{--                            <input type="text" disabled value="{{ $message }}" class="bg-danger">--}}
...
{{--                        <div class="form__field">--}}
{{--                            <input type="password" name="password_confirmation" {{ old('password_confirmation') }} placeholder="•••••••••">--}}
{{--                        </div>--}}
{{--                        <div class="form__field">--}}
...
{{--                    <p>Already have an accout? <a href="{{ route('login.index') }}">Log in</a></p>--}}

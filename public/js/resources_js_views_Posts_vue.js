  ...
  methods: {
    ...
    destroy_post: function destroy_post(id) {
      ...
      this.$store.dispatch('Post/destroy', id).then(function () {
        _this2.$store.dispatch('Post/get_posts_by_user_id').then(function () {});
      });
    }
  }
});
        ...
        return _c("div", { key: post.id, staticClass: "col post-card" }, [
          _c("div", { staticClass: "card" }, [
            _c("img", {
              ...
              attrs: { src: "storage/Post-avatars/" + post.image, alt: "..." }
            }),
            _vm._v(" "),
            _c("div", { staticClass: "card-body" }, [
              ...
              _c(
                "p",
                {
                  ...
                  on: { dblclick: _vm.activate_change }
                },
              ...
              _c("input", {
                ...
                staticClass: "card-text change_input",
